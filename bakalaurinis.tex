...
\subsubsubsection{VGSL specifikacijos}
...
\subsubsubsection{Syntax of the Layers in between}
...
\subsubsubsection{Variable size inputs and summarizing LSTM}
...
\subsubsubsection{Programos įgyvendinimui panaudotas modelis}
